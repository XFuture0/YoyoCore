...
为了更好地上手Yoyo_Core,它提供了一个专门的skill来配合vibe coding一起使用，只需要在agent中使用"使用yoyo_Core的方式写代码"时，即可以应用此技能基于Yoyo_Core框架的代码逻辑编写代码。

具体内容和文档可查看`Skills_Extra`文档,README中有该SKILL的安装方式和使用文档（0 v 0）。
